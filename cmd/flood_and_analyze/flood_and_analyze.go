...
import (
	...
	"github.com/I330716/test-fluentd-elastic-search/pkg/operations/analyse"
...
func main() {
	...
	var testName = flag.String("testname", "flood-and-analyze-001", "The test name which will be needed by the master")
	flag.Parse()
	...
	masterClient.Init(*masterEndPoint, *workerName, *testName)
